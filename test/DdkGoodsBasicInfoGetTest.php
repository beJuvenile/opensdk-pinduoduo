...
use OpenSDK\PinDuoDuo\Requests\DdkGoodsBasicInfoGetRequest;

class DdkGoodsBasicInfoGetTest
{
    ...
    public function __invoke()
    {
        ...
        $req = new DdkGoodsBasicInfoGetRequest();
        $req->setGoodsIdList([34563598420]);
        $c->setRequest($req);
        $result = $c->execute();
