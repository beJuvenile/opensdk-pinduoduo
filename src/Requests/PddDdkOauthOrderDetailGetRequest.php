 ...
 * 查询订单详情
 *
 * @link https://open.pinduoduo.com/#/apidocument/port?portId=pdd.ddk.oauth.order.detail.get
...
class PddDdkOauthOrderDetailGetRequest implements Request
{
     ...
     * @var string
     */
    public $method = 'pdd.ddk.oauth.order.detail.get';
