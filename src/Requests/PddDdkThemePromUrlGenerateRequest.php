 ...
 * 多多进宝主题推广链接生成
 *
 * @link https://open.pinduoduo.com/#/apidocument/port?portId=pdd.ddk.theme.prom.url.generate
...
class PddDdkThemePromUrlGenerateRequest implements Request
{
     ...
     * @var string
     */
    public $method = 'pdd.ddk.theme.prom.url.generate';
    ...
    private $generate_we_app; // 是否生成小程序链接
