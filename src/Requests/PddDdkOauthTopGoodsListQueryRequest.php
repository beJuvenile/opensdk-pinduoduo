 ...
 * 多多客工具获取爆款排行商品接口
 *
 * @link: https://open.pinduoduo.com/#/apidocument/port?portId=pdd.ddk.oauth.top.goods.list.query
...
class PddDdkOauthTopGoodsListQueryRequest implements Request
{
     ...
     * @var string
     */
    public $method = 'pdd.ddk.oauth.top.goods.list.query';
