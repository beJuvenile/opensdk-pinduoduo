 ...
 * 多多客生成店铺推广链接API
 *
 * @link https://open.pinduoduo.com/#/apidocument/port?portId=pdd.ddk.mall.url.gen
...
class PddDdkMallUrlGenRequest implements Request
{
     ...
     * @var string
     */
    public $method = 'pdd.ddk.mall.url.gen';
