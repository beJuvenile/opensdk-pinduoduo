 ...
 * 多多客工具生成多多口令接口
 *
 * @link https://open.pinduoduo.com/#/apidocument/port?portId=pdd.ddk.oauth.phrase.generate
...
class PddDdkOauthPhraseGenerateRequest implements Request
{
     ...
     * @var string
     */
    public $method = 'pdd.ddk.oauth.phrase.generate';
