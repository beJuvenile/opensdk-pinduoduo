 ...
 * 拼多多主站频道推广接口
 *
 * @link https://open.pinduoduo.com/#/apidocument/port?portId=pdd.ddk.oauth.resource.url.gen
...
class PddDdkOauthResourceUrlGenRequest implements Request
{
     ...
     * @var string
     */
    public $method = 'pdd.ddk.oauth.resource.url.gen';
