 ...
 * 查询CPA数据
 *
 * @link https://open.pinduoduo.com/#/apidocument/port?portId=pdd.ddk.finance.cpa.query
...
class PddDdkFinanceCpaQueryRequest implements Request
{
     ...
     * @var string
     */
    public $method = 'pdd.ddk.finance.cpa.query';
