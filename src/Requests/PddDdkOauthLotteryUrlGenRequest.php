 ...
 * 多多客工具生成转盘抽免单url
 *
 * @link https://open.pinduoduo.com/#/apidocument/port?portId=pdd.ddk.oauth.lottery.url.gen
...
class PddDdkOauthLotteryUrlGenRequest implements Request
{
     ...
     * @var string
     */
    public $method = 'pdd.ddk.oauth.lottery.url.gen';
