 ...
 * 生成商城-频道推广链接
 *
 * @link: https://open.pinduoduo.com/#/apidocument/port?portId=pdd.ddk.cms.prom.url.generate
 *
...
class DdkCmsPromUrlGenerateRequest implements Request
{
     ...
     * @var string
     */
    public $method = 'pdd.ddk.cms.prom.url.generate';
